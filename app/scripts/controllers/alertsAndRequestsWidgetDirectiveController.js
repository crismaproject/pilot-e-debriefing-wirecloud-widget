...
//               numberRows: 6
      ...
      $scope.$watch('alertsAndRequestsData', function () {
        if (DEBUG) {
          console.log('alerts and requests: alertsAndRequestsData changed!');
          console.log('alerts and requests: paintChart()!');
        }
        paintChart();
      });
      
//      $scope.$watch('reqVehiclesListData', function () {
//        if (DEBUG) {
//          console.log('alerts and requests: reqVehiclesListData changed!');
//          console.log('reqVehiclesListData: ' + $scope.reqVehiclesListData.toSource());
//          console.log('alerts and requests: paintChart()!');
//        }
//        paintChart();
//      });
...
//        $scope.alertsRequestsCheckCorrectTimestamp[numberOfArrivals - 1][0]).format('YYYY-MM-DD HH:mm:ss');
      ...
      $scope.calculateAlertsAndRequests = function(
        ...
        $scope.$parent.$parent.totNumVehicles = $scope.totalNbrVehicles;
        ...
        $scope.$parent.$parent.alertsData = $scope.alertTimesAndMessages;
